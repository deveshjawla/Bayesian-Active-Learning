...
n_output = $n_output
# neural_network = Chain(Conv((3,3), 1 =>8, mish), Conv((3,3), 8=>8, mish),  Conv((5,5), 8=>8, mish),Conv((5,5), 8=>8, mish), Conv((7,7), 8=>8, mish), Conv((7,7), 8=>8, mish), Flux.flatten, Dense(128 => 10, mish), Dense(10 => 10), softmax)
