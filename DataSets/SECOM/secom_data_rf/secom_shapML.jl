...
features = readdlm("Data/SECOM/moldovan_data/secom_data_preprocessed_moldovan2017.csv", ',', Float32)

labels = Int.(readdlm("Data/SECOM/moldovan_data/secom_labels.txt", ' ')[:, 1])
