...
function bayesian_inference(prior::Tuple, training_data::Tuple{Array{Float32,2},Array{Float32,2}}, nsteps::Int, n_chains::Int, al_step::Int, experiment_name::String, pipeline_name::String, mcmc_init_params, temperature, likelihood_name, prior_informativeness)::Tuple{Array{Float32,2},Float32}
    ...
    if temperature isa Number && likelihood_name == "Regression"
