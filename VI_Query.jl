...
function bnn_query(prior::Tuple, pool::Tuple, previous_training_data, input_size::Int, n_output::Int, param_matrix, al_step::Int, test_data, experiment_name::String, pipeline_name::String, acq_size_::Int, nsteps::Int, n_epochs::Int, al_sampling::String)::Tuple{Tuple{Array{Float32, 2}, Array{Float32, 2}}, Array{Float32, 2}, Array{Float32, 2}, Float32, Float32}
	...
	independent_param_matrix, elapsed = bayesian_inference(prior, training_data_xy, nsteps, n_epochs, al_step, experiment_name, pipeline_name)
